...
namespace Infrastructure.Serialization
{
    ...
    public class ServicestackTextSerializer : ITextSerializer
    {
        ...
        {
            TypeSerializer.SerializeToWriter(graph, writer);
            writer.Flush();
        }

        public object Deserialize(TextReader reader)
        {
            return TypeSerializer.DeserializeFromReader<object>(reader);
        }
    }
    ...
    public class JsonTextSerializer : ITextSerializer
    {
        ...
        public JsonTextSerializer()
            : this(Newtonsoft.Json.JsonSerializer.Create(new JsonSerializerSettings
            {
        ...
        public JsonTextSerializer(Newtonsoft.Json.JsonSerializer serializer)
        {
